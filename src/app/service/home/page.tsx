          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-4">
              ...
              <a href="/" className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-lg font-bold leading-none">Kids Fashion</div>
                  <div className="text-xs text-gray-500 -mt-1">Comfort & Joy</div>
                </div>
              </a>
            </div>
            ...
            <div className="flex-1 mx-6 hidden md:block">
              <div className="relative">
                <input
                  ...
                  placeholder="Search clothing, sizes, colors..."
                  className="w-full rounded-full border border-gray-200 bg-white py-3 px-4 pl-10 focus:outline-none focus:ring-2 focus:ring-green-300"
                />
            ...
            <div className="flex items-center gap-4">
              <a href="/account" className="hidden md:flex items-center gap-2 text-sm text-gray-700 hover:text-gray-900">
                <User size={18} />
                <span>Account</span>
              </a>

              <a href="/store-locator" className="hidden md:flex items-center gap-2 text-sm text-gray-700 hover:text-gray-900">
                <MapPin size={18} />
                <span>Stores</span>
              </a>

              <a href="tel:+15551234567" className="hidden md:flex items-center gap-2 text-sm text-gray-700 hover:text-gray-900">
                <Phone size={18} />
                <span>+1 555 123 4567</span>
              </a>

              <a href="/wishlist" className="p-2 rounded-full hover:bg-gray-100">
                <Heart size={18} />
              </a>

              <a href="/cart" className="relative inline-flex items-center p-2 rounded-full bg-green-600 text-white hover:bg-green-700">
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 py-16 sm:py-20 lg:py-24 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="mt-4 text-lg text-gray-700 max-w-xl">
                Soft fabrics, playful prints and perfectly safe materials. Explore stylish outfits for ages 0–10 with free returns and fast delivery.
              </p>

              <div className="mt-6 flex gap-4">
                <a href="/shop" className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-green-600 text-white font-semibold hover:bg-green-700 transition-shadow shadow">
                  Shop Collection
                </a>
                <a href="/sale" className="inline-flex items-center gap-3 px-6 py-3 rounded-full border border-gray-200 text-gray-800 hover:bg-gray-100">
                  View Sale
                </a>
              </div>
              ...
              <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-md">
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-white rounded-lg shadow-sm"><ShoppingCart size={20} className="text-green-600" /></div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-white rounded-lg shadow-sm"><Heart size={20} className="text-pink-500" /></div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-white rounded-lg shadow-sm"><BadgeIcon /></div>
                  <div>
                    <div className="text-sm font-semibold">Quality Assured</div>
                    <div className="text-xs text-gray-500">Kid-safe fabrics</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 flex items-center justify-center">
              <div className="w-full max-w-xl relative rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute bottom-4 left-4 bg-white/80 rounded-lg px-4 py-2 shadow">
                  ...
                  <div className="text-xs text-gray-600">Spring Collection 2025</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            <CategoryCard icon={<Baby size={48} className="text-pink-500" />} title="Newborn" />
            <CategoryCard icon={<Shirt size={48} className="text-green-500" />} title="Tops" />
            <CategoryCard icon={<Handbag size={48} className="text-purple-500" />} title="Accessories" />
            <CategoryCard icon={<Handbag size={48} className="text-yellow-500" />} title="Outerwear" />
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 py-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <a href="/shop" className="text-sm text-green-600 font-medium hover:underline">Browse all</a>
          </div>

          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3].map((n) => (
                <div key={n} className="animate-pulse bg-white rounded-lg p-6 h-72" />
              ))}
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {(filteredProducts.length ? filteredProducts : products.slice(0, 6)).map((p) => (
        ...
        <section className="max-w-3xl mx-auto px-4 py-12">
          <div className="bg-white rounded-xl shadow p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Get 10% off your first order and be the first to see new arrivals.</p>

            <form onSubmit={subscribeNewsletter} className="flex flex-col sm:flex-row gap-3 justify-center">
              <input
              ...
              />
              <button type="submit" className="px-6 py-3 rounded-full bg-green-600 text-white font-semibold hover:bg-green-700">
        ...
        <footer className="bg-white border-t mt-12">
          <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-600">Cute, comfy and safe clothing for kids. Delivered with care.</p>
...
function CategoryCard({ icon, title }: { icon: React.ReactNode; title: string }) {
  return (
    <a href={`/shop?category=${encodeURIComponent(title.toLowerCase())}`} className="block bg-white rounded-xl shadow p-6 text-center hover:shadow-lg transition">
...
function CollectionCard({ title, subtitle, image }: { title: string; subtitle: string; image: string }) {
  return (
    <a href="/shop" className="group block overflow-hidden rounded-2xl shadow-lg">
  ...
  return (
    <div className="bg-white rounded-xl shadow p-4 flex flex-col">
      ...
      <div className="mt-4 flex items-center gap-3">
        ...
        <button onClick={() => onAdd(product)} className="ml-auto inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-600 text-white hover:bg-green-700">
          <ShoppingCart size={16} />
          Add
        </button>
        <button className="p-2 rounded-full border"><Heart size={16} /></button>
      </div>
    </div>
  );
}
...
function BadgeIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M12 2l2.09 4.26L19 7.27l-3 2.92.71 5.19L12 14.77 7.29 15.38 8 10.19 5 7.27l4.91-.99L12 2z" fill="#F59E0B" />
    </svg>
  );
}
